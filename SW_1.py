...
#match value and gap cost are tuneable parameters 
def matrix(a,b,match_value= 4, gap_cost = 2):
...
#traceback, starting at the highest value, finding path of most reward 
